...
sudo apt-get install -y -q paper-icon-theme
echo "[ ... Installing 'Paper' GTK theme]"
sudo apt-get install -y -q paper-gtk-theme
echo "[ ... Installing 'Paper' cursors]"
sudo apt-get install -y -q paper-cursor-theme
...
sudo apt-get install -y -q plank
